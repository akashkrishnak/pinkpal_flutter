...
Future<bool> requestNotificationPermissions(
  ...
  const String channelKey = "emergency_channel";
        ...
        builder: (context) => AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  Text(
                    'To proceed, you need to enable the permissions above${channelKey.isEmpty ? '' : ' on channel $channelKey'}:',
                    maxLines: 2,
                    textAlign: TextAlign.center,
                  ),
